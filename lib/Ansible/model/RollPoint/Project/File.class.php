...
require_once(dirname(dirname(dirname(__FILE__))) .'/Local.class.php');

class Ansible__RollPoint__Project__File extends Ansible__ORM__Local {
    protected $__table       = 'rlpt_proj_file';
