 ...
 * @param string $criteria  a single field name, an array of fields to sort by, or an array of 2-dimensional arrays: (fieldname, bool do_descending)
 * @return string
 */
 ...
 * supported by the {@link SimpleORM} relations system.  This
